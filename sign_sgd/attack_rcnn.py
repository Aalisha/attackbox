...
from OPT_attack_sign_SGD_rcnn import OPT_attack_sign_SGD_rcnn
from models import PytorchModel
import torch
import torchvision
import torchvision.models as models
from allmodels import  load_model, MNIST, load_mnist_data, load_cifar10_data, CIFAR10, IMAGENET, load_imagenet_data, load_coco_data
import numpy as np
...
parser.add_argument('--num', default=2500, type=int,
...
def attack(algorithm, dataset, targeted, norm='l2', num=2500, stopping_criteria=None,
    ...
    if dataset == 'mnist':
        ...
        load_model(net,'/home/aalishadalal/sign-opt-detection/attackbox/model/mnist_gpu.pt')
        ...
        net.cuda()
        net = torch.nn.DataParallel(net, device_ids=[0])
        train_loader, test_loader, train_dataset, test_dataset = load_coco_data()
    else:
    ...
    for i, data in enumerate(test_loader):
        ...
        adv, dist = attack(xi.cuda(), yi, target=target,
